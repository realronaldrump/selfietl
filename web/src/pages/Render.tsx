...
import { api, renderPlaybackUrl, renderPosterUrl, type JobStatus, type Project, type RenderConfig } from "@/api/client";
  ...
  return (
    <PageFrame size="wide" className="grid gap-4 space-y-0 xl:grid-cols-[minmax(0,1fr)_24rem]">
      ...
      <Panel>
        ...
        {latestDone ? (
          <div className="mt-4">
            <video className="max-h-[70vh] max-w-full rounded-md bg-ink" controls poster={renderPosterUrl(latestDone.id)} src={renderPlaybackUrl(latestDone.id)} />
